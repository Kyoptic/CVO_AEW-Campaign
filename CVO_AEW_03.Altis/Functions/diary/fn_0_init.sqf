...
[] call cvo_diary_fnc_createDiaryCategory;

["I. Situation", "CVO", " "] call cvo_diary_fnc_createDiaryCategory;
...
["II. Mission", "CVO", " "] call cvo_diary_fnc_createDiaryCategory;
[] call diary_fnc_2_mission;


["III. Execution", "CVO", " "] call cvo_diary_fnc_createDiaryCategory;
[] call diary_fnc_3_execution;


["IV. Admin", "CVO", " "] call cvo_diary_fnc_createDiaryCategory;
...
["V. Command", "CVO", " "] call cvo_diary_fnc_createDiaryCategory;
