if (hasInterface) then {
    ...
    [] spawn {
		...
		playmusic "AmbientTrack02b_RF"; //OST_03_RF
        sleep 1;

		"disclaimerLayer_Sponsor" cutText ["<img size='8' shadow='0' image='Images\voron_sponsor.paa'/>", "PLAIN DOWN", 5, true, true];

        "disclaimerLayer_Text" cutText  ["<t size='2'> Negades Bay, Altis, 2035. An hour before dawn...</t>", "PLAIN", 5, true, true];
