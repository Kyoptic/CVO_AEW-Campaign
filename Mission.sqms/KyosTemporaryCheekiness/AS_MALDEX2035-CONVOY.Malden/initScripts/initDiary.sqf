...
_player createDiaryRecord ["Diary", ["Additional","
	1- There are 2 additional unarmed MRAPs to allocate if necessary (for example as replacements in case of losses).<br/>
	2- This mission has you playing as if you were part of a simulated military exercise. Of course, this is Arma, so it’s already a simulation. Shoot to kill, explosions hurt, etc.<br/>"
]];

_player createDiaryRecord ["Diary", ["Execution","
	1- Escort the BADGER CV safely along the marked coastal road. It cannot leave the road.<br/>
	2- Clear the road of any IEDs and ambushes.<br/>
	3- Assault then secure the OPFOR HQ.<br/>"
]];

_player createDiaryRecord ["Diary", ["Mission","
	For this exercise, your platoon must clear the western coastside road. The exercise rules state that the plt HQ vehicle, a BADGER CV (Command Vehicle) must stay on the road. Escort the CV to the end of the marked route, then assault and capture the OPFOR HQ.<br/>"
]];

_player createDiaryRecord ["Diary", ["Situation","
	Malden's armed forces (MAF) and the Altis Armed Forces (AAF) are part of METO - the MEditerranean Treaty Organization. This alliance of Mediterranean micro nations offers a joint security pact to ensure their sovereignty against larger powers. To promote METO joint operability and improve their training, METO holds an annual Malden Exercise - MALDEX. During these, METO members carry out simulated oppositional scenarios, where each side takes a specific role in a scenario with a focus on specific capabilities. For MALDEX 2035, Malden's Armed Forces wish to test their convoy operations in a hostile environment, in preparation for peacekeeping operations in Takistan. The AAF has agreed to play as 'OPFOR' for this exercise, and so will be using insurgent tactics and capabilities.<br/>"
]];
