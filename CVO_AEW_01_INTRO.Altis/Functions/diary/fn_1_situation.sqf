...
[
    ...
    ,""
    ,"
The 24th Chorni Vorn has been hired as a subcontractor to Myrmidones Inc, a PMC that was started by a group of ex-Altis war veterans, ostensibly to help in peacekeeping and counterinsurgency operations around the world.<br/><br/>
As Altis has fallen into chaos once more, Myrmidones has gained valuable contracts from the New Altis Government and the United Nations.<br/><br/>
With good knowledge of the land and the people, and the benefit of being a separate entity from the NAA, the Myrmidones can travel more freely across the island than even the NAA. Tasked with the supervision of food and aid distribution, VIP escort and demining operations, they have recently found a gap in their EOD capabilities.<br/><br/>The 24th has been hired to fill that gap...
"
    // ,_icon       // Image next to the entry Title (small flags for example)
    // ,_newName
    // ,_target
...
Without a centrally authorised government, civilians and old FIA cells on Altis have formed local - legally armed - militias. Some of these operate as local cooperatives, helping others in times of need, while others operate as little more than protection rackets and criminal gangs. Gradually, with the help of Greece the old FIA leader Nikos has been elected president of a provisional government, forming the Second Altian Republic.<br/><br/>
...
As the Second Altis Republic begins to train its own armed forces, the New Altis Army, it fills gaps in its capabilities with a contingent of the Hellenic Armed Forces (HAF) invited onto the island to help keep the peace; and through the skills of Myrmidon Inc, a private military company largely comprised of ex Veterans of NATO from the east wind conflict. Experienced in counterinsurgency, Myrmidon has recently discovered a conspicuous gap in their EOD skills. A gap the 24th Chorni Voron has been contracted to fill...
"
    // ,_icon       // Image next to the entry Title (small flags for example)
    // ,_newName
    // ,_target
